            ...
            <div class="card-body login-img">
              <div class="row m-0">
                ...
                <div class="col-lg-6 col-md-12 bg-white px-4 pt-3">
                  <form class="login-form" action="<?=site_url('send_token')?>" method="post">
                  <h4 class="mb-2 card-title">Forget Password</h4>
                  <p class="card-text mb-3">
                        ...
                        <?php
                            ...
                            ?>
                            <div class="noty_bar noty_type_error" id="noty_1521948415920250000" style="color:red"><div class="noty_message" style="text-align: center; padding: 10px; width: auto; position: relative; font-weight: bold;"><span class="noty_text"><?php echo $flash_desc; ?></span></div></div>
                            <?php
                                }
                              }
                ...
                <div class="col-md-12 mb-1 mr-2" >
                  <a href="<?=site_url('login')?>" style="margin-left:-16px!important;"><i class="ft-user-x"></i> Sign in?</a>
                </div>
