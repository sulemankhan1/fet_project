          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="card-block mcontainer">
                ...
                <a href="javascript:void(0)" class="btn btn-sm btn-outline-info multi_checkbox_btn" data="active" style=" float:right; "><i class="ft-user-check"></i> <?=__('active_status_txt')?> </a>
                  ...
                  <table class="table table-striped table-bordered table-hover table-checkable order-column display" id="DataTable" style="width:100%">
                      <thead>
                          <tr>
                            ...
                            <th><?=__('active_txt')?></th>
                            <?php if ($this->session->userdata('is_user_d_to_a') == 'yes' || $this->session->userdata('is_user_vd') == 'yes' || $this->session->userdata('is_user_dd') == 'yes'): ?>
